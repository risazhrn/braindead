    ...
    <div class="row">
        <div class="col-xxl-12">
            <div class="page__title-wrapper mb-55">
                <h2 class="page__title-2">Profile Information</h2>
                    ...
                    <form action="{{ route('profile.update') }}" method="POST">
                        ...
                        <div class="row">
                                ...
                                <div class="contact__input-wrapper mb-25">
                                    <h5 for="name" :value="__('Name')">Name</h5>
                            ...
                            <div class="row">
                                <div class="col-xxl-12">
                                    <div class="contact__input-wrapper mb-25">
                                        <h5 for="email" :value="__('Email')">Email</h5>
                                        <div class="contact__input">
                                            <input id="email" name="email" type="email" class="form-control"
                                                placeholder="Enter Email" aria-label="name"
                                                aria-describedby="addon-wrapping" :value="old('email', $user - > email)"
