    ...
    <!-- sign up area start -->
         <section class="signup__area po-rel-z1 pt-100 pb-145">
            <div class="sign__shape">
               <img class="man-1" src="{{asset('/img/icon/sign/man-3.png')}}" alt="">
               <img class="man-2 man-22" src="{{asset('/img/icon/sign/man-2.png')}}" alt="">
               ...
               <img class="flower" src="{{asset('/img/icon/sign/flower.png')}}" alt="">
            </div>
            <div class="container">
               <div class="row">
