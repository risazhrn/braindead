             ...
             <div class="postbox__wrapper">
                <article class="postbox__item format-image fix mb-50 wow fadeInUp" data-wow-delay=".2s">
                   ...
                   <div class="postbox__content">
                      ...
                      <h3 class="postbox__title mb-15"><a href="{{route('detail-question')}}">Why we decide to build a collaborative UX design tools platform?</a></h3>
                ...
                <article class="postbox__item  format-video fix mb-50 wow fadeInUp" data-wow-delay=".5s">
                   ...
                   <div class="postbox__content">
                      ...
                      <h3 class="postbox__title mb-15"><a href="{{route('detail-question')}}">Marketplace SEO: Tips for Etsy, Markit & Amazon Handmade</a></h3>
                      <div class="postbox__text mb-20">
                         <p>The little rotter absolutely bladdered wind up victoria sponge starkers cack posh jolly good lost the plot nancy boy bonnet plastered.</p>
                      </div>
                      <div class="postbox__author d-flex align-items-center">
                         ...
                         <div class="rc__post-wrapper">
                            <div class="rc__post d-flex align-items-center">
                               <div class="rc__thumb mr-15">
                                  <a href="{{route('detail-question')}}"><img src="assets/img/blog/sm/blog-sm-1.jpg" alt=""></a>
                               </div>
                               <div class="rc__content">
                                  <div class="rc__meta">
                                     <span>October 15, 2021</span>
                                  </div>
                                  <h6 class="rc__title"><a href="{{route('detail-question')}}">Communication Between Departments</a></h6>
                               </div>
                            </div>
                            <div class="rc__post d-flex align-items-center">
                               <div class="rc__thumb mr-15">
